...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/audio/sku_lahaina/audio_effects.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio/sku_lahaina/audio_effects.xml \
    ...
    $(LOCAL_PATH)/audio/sku_lahaina/audio_platform_info_intcodec.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio/sku_lahaina/audio_platform_info_intcodec.xml \
    $(LOCAL_PATH)/audio/sku_lahaina/mixer_paths_hhg.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio/sku_lahaina/mixer_paths_hhg.xml \
...
$(call soong_config_set,lineage_health,charging_control_charging_path,/sys/class/power_supply/battery//sys/class/qcom-battery/battcharge_input_suspend)
...
$(call soong_config_set,libinit,vendor_init_lib,//$(LOCAL_PATH):libinit_nicole)
...
$(call soong_config_set,qtipower,tap_to_wake_node,/sys/devices/platform/soc/a90000.spi/spi_master/spi0/spi0.0/fts_gesture_mode)
...
$(call inherit-product, vendor/razer/nicole/nicole-vendor.mk)
